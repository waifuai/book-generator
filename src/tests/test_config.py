...
class TestAPIConfig(unittest.TestCase):
    ...
    @patch('config.Path.open', new_callable=mock_open, read_data="test-api-key")
    @patch('config.Path.expanduser')
    @patch('config.genai.configure') # Mock the actual configure call
    ...
    def test_api_config_file_not_found(self, mock_expanduser):
        ...
        with patch('config.Path.open', side_effect=FileNotFoundError):
    ...
    @patch('config.Path.open', new_callable=mock_open, read_data="") # Simulate empty file
    @patch('config.Path.expanduser')
    ...
    @patch('config.Path.open', new_callable=mock_open, read_data="test-api-key")
    @patch('config.Path.expanduser')
    @patch('config.genai.configure', side_effect=Exception("Configuration failed")) # Simulate genai failure
